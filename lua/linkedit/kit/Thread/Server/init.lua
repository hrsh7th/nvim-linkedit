...
local Session = require('linkedit.kit.Thread.Server.Session')
...
---@class linkedit.kit.Thread.Server
---@field private dispatcher fun(session: linkedit.kit.Thread.Server.Session): nil
---@field private session? linkedit.kit.Thread.Server.Session
...
---@param dispatcher fun(session: linkedit.kit.Thread.Server.Session): nil
---@return linkedit.kit.Thread.Server
...
function Server:connect()
  return Async.run(function()
    ...
    vim.api.nvim_create_autocmd({ 'VimLeave' }, {
      desc = 'linkedit.kit.Thread.Server:on_exit',
      once = true,
      callback = function()
        self:kill()
      end
