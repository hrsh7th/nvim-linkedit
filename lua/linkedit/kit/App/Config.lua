...
local Cache = require('linkedit.kit.App.Cache')

---@class linkedit.kit.App.Config.Schema

---@alias linkedit.kit.App.Config.SchemaInternal linkedit.kit.App.Config.Schema|{ revision: integer }

---@class linkedit.kit.App.Config
---@field private _cache linkedit.kit.App.Cache
---@field private _default linkedit.kit.App.Config.SchemaInternal
---@field private _global linkedit.kit.App.Config.SchemaInternal
---@field private _filetype table<string, linkedit.kit.App.Config.SchemaInternal>
---@field private _buffer table<integer, linkedit.kit.App.Config.SchemaInternal>
local Config = {}
Config.__index = Config

---Create new config instance.
---@param default linkedit.kit.App.Config.Schema
...
---@param config linkedit.kit.App.Config.Schema
...
---@return linkedit.kit.App.Config.Schema
function Config:get()
...
---@return fun(config: linkedit.kit.App.Config.Schema)|{ filetype: fun(filetypes: string|string[], config: linkedit.kit.App.Config.Schema), buffer: fun(bufnr: integer, config: linkedit.kit.App.Config.Schema) }
