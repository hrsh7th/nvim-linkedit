local LSP = require('linkedit.kit.LSP')
local AsyncTask = require('linkedit.kit.Async.AsyncTask')

---@class linkedit.kit.LSP.Client
...
---@param client table
---@return linkedit.kit.LSP.Client
...
---@param params linkedit.kit.LSP.ImplementationParams
...
---@param params linkedit.kit.LSP.TypeDefinitionParams
...
---@class linkedit.kit.LSP.IntersectionType01 : linkedit.kit.LSP.ConfigurationParams, linkedit.kit.LSP.PartialResultParams

---@param params linkedit.kit.LSP.IntersectionType01
...
---@param params linkedit.kit.LSP.DocumentColorParams
...
---@param params linkedit.kit.LSP.ColorPresentationParams
...
---@param params linkedit.kit.LSP.FoldingRangeParams
...
---@param params linkedit.kit.LSP.DeclarationParams
...
---@param params linkedit.kit.LSP.SelectionRangeParams
...
---@param params linkedit.kit.LSP.WorkDoneProgressCreateParams
...
---@param params linkedit.kit.LSP.CallHierarchyPrepareParams
...
---@param params linkedit.kit.LSP.CallHierarchyIncomingCallsParams
...
---@param params linkedit.kit.LSP.CallHierarchyOutgoingCallsParams
...
---@param params linkedit.kit.LSP.SemanticTokensParams
...
---@param params linkedit.kit.LSP.SemanticTokensDeltaParams
...
---@param params linkedit.kit.LSP.SemanticTokensRangeParams
...
---@param params linkedit.kit.LSP.ShowDocumentParams
...
---@param params linkedit.kit.LSP.CreateFilesParams
...
---@param params linkedit.kit.LSP.RenameFilesParams
...
---@param params linkedit.kit.LSP.DeleteFilesParams
...
---@param params linkedit.kit.LSP.MonikerParams
...
---@param params linkedit.kit.LSP.TypeHierarchyPrepareParams
...
---@param params linkedit.kit.LSP.TypeHierarchySupertypesParams
...
---@param params linkedit.kit.LSP.TypeHierarchySubtypesParams
...
---@param params linkedit.kit.LSP.InlineValueParams
...
---@param params linkedit.kit.LSP.InlayHintParams
...
---@param params linkedit.kit.LSP.InlayHint
...
---@param params linkedit.kit.LSP.DocumentDiagnosticParams
...
---@param params linkedit.kit.LSP.WorkspaceDiagnosticParams
...
---@param params linkedit.kit.LSP.RegistrationParams
...
---@param params linkedit.kit.LSP.UnregistrationParams
...
---@param params linkedit.kit.LSP.InitializeParams
...
---@param params linkedit.kit.LSP.ShowMessageRequestParams
...
---@param params linkedit.kit.LSP.WillSaveTextDocumentParams
...
---@param params linkedit.kit.LSP.CompletionParams
...
---@param params linkedit.kit.LSP.CompletionItem
...
---@param params linkedit.kit.LSP.HoverParams
...
---@param params linkedit.kit.LSP.SignatureHelpParams
...
---@param params linkedit.kit.LSP.DefinitionParams
...
---@param params linkedit.kit.LSP.ReferenceParams
...
---@param params linkedit.kit.LSP.DocumentHighlightParams
...
---@param params linkedit.kit.LSP.DocumentSymbolParams
...
---@param params linkedit.kit.LSP.CodeActionParams
...
---@param params linkedit.kit.LSP.CodeAction
...
---@param params linkedit.kit.LSP.WorkspaceSymbolParams
...
---@param params linkedit.kit.LSP.WorkspaceSymbol
...
---@param params linkedit.kit.LSP.CodeLensParams
...
---@param params linkedit.kit.LSP.CodeLens
...
---@param params linkedit.kit.LSP.DocumentLink
...
---@param params linkedit.kit.LSP.DocumentFormattingParams
...
---@param params linkedit.kit.LSP.DocumentRangeFormattingParams
...
---@param params linkedit.kit.LSP.DocumentOnTypeFormattingParams
...
---@param params linkedit.kit.LSP.RenameParams
...
---@param params linkedit.kit.LSP.PrepareRenameParams
...
---@param params linkedit.kit.LSP.ExecuteCommandParams
...
---@param params linkedit.kit.LSP.ApplyWorkspaceEditParams
