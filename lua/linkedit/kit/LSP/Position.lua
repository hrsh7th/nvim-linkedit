...
---@param encoding? linkedit.kit.LSP.PositionEncodingKind
...
---@param bufnr number
---@param position linkedit.kit.LSP.Position
---@param from_encoding? linkedit.kit.LSP.PositionEncodingKind
...
---@param position linkedit.kit.LSP.Position
---@param from_encoding? linkedit.kit.LSP.PositionEncodingKind
---@return linkedit.kit.LSP.Position
...
---@param position linkedit.kit.LSP.Position
---@param from_encoding linkedit.kit.LSP.PositionEncodingKind
---@param to_encoding linkedit.kit.LSP.PositionEncodingKind
