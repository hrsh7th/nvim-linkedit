...
---@class linkedit.kit.Async.AsyncTask
---@field private value any
---@field private status linkedit.kit.Async.AsyncTask.Status
...
---@param task linkedit.kit.Async.AsyncTask
---@param status linkedit.kit.Async.AsyncTask.Status
---@param value any
...
---@enum linkedit.kit.Async.AsyncTask.Status
AsyncTask.Status = {
  Pending = 0,
  Fulfilled = 1,
  Rejected = 2,
...
---@return { status: linkedit.kit.Async.AsyncTask.Status, value: any }
