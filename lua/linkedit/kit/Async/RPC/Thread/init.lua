...
local Session = require('linkedit.kit.Async.RPC.Session')

---@class linkedit.kit.Async.RPC.Thread
---@field private thread uv.luv_thread_t
---@field private session linkedit.kit.Async.RPC.Session
local Thread = {}
Thread.__index = Thread

---Create new thread.
---@param dispatcher_ fun(session: linkedit.kit.Async.RPC.Session)
